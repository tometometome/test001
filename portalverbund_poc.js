...
function portalverbundPocConsoleLogChalk(currentText) {
  ...
  if ( currentPortalColor === "darkgreen" ) { console.log(portalverbundPocModuleChalk.green(currentText.toString())); }
  if ( currentPortalColor === "blue" ) { console.log(portalverbundPocModuleChalk.blue(currentText.toString())); }
  if ( currentPortalColor === "red" ) { console.log(portalverbundPocModuleChalk.red(currentText.toString())); }
...
//  console.log('Portalverbund-Broker laeuft ...');
  ...
  portalverbundPocConsoleLogChalk("=> MQTT-Broker ist gestartet.");
